  ...
  function T(a, b, c) {
    ...
    if (c)
      for (b = 0; b < c.length; b++)
        (a = c[b]),
          a < this.l ? ((a += this.j), (d = this.g[a]) ? fb(d) : (this.g[a] = mb)) : (nb(this), (d = this.h[a]) ? fb(d) : (this.h[a] = mb));
  }
        ...
        : isNaN(d)
          ...
          : 3.4028234663852886e38 < d
            ...
            : 1.1754943508222875e-38 > d
              ? ((d = Math.round(d / Math.pow(2, -149))), (N = 0), (M = ((c << 31) | d) >>> 0))
        ...
        (h = a[e++]),
          128 > h
            ...
            : 224 > h
              ? e >= d
                ? f.push(65533)
                : ((l = a[e++]), 194 > h || 128 !== (l & 192) ? (e--, f.push(65533)) : f.push(((h & 31) << 6) | (l & 63)))
              : 240 > h
                ? e >= d - 1
                  ? f.push(65533)
                  : ((l = a[e++]),
                    128 !== (l & 192) || (224 === h && 160 > l) || (237 === h && 160 <= l) || 128 !== ((g = a[e++]) & 192)
                      ? (e--, f.push(65533))
    ...
    if (0 !== e)
      throw Error(
        'Message parsing ended unexpectedly. Expected to read ' +
          (k + ' bytes, instead read ' + (k - e) + ' bytes, either the data ended unexpectedly or the message misreported its own length'),
      );
    a.g.g = h;
    a.g.i = f;
    qb(b, c, g, d, void 0);
        ...
        case 2:
          ...
          if ('object' === typeof window)
            return (
              ...
              fc('createMediapipeSolutionsPackedAssets', { locateFile: a.locateFile }),
              ...
              (l = Promise.all(
                ...
                return H(function (w) {
                  if (1 == w.g)
                    return (
                      (m = window.createMediapipeSolutionsWasm), (q = window.createMediapipeSolutionsPackedAssets), (t = a), F(w, m(q), 2)
                    );
                  t.h = w.h;
                  w.g = 0;
                });
        ...
        (h in this.j && this.j[h] === a[h]) ||
          ...
          void 0 !== k &&
            ...
            k.graphOptionXref &&
              ...
              (k = Object.assign(Object.assign(Object.assign({}, { calculatorName: '', calculatorIndex: 0 }), k.graphOptionXref), h)),
              e.push(k))));
      }
      if (0 !== d.length || 0 !== e.length)
        (this.o = !0), (this.A = (void 0 === this.A ? [] : this.A).concat(e)), (this.v = (void 0 === this.v ? [] : this.v).concat(d));
    }
  };
  function nc(a) {
    var b, c, d, e, g, f, k;
    ...
    return H(function (v) {
      switch (v.g) {
        case 1:
          ...
          g = C(Object.keys(c));
          for (f = g.next(); !f.done; f = g.next())
            (k = f.value), (h = c[k]), 'string' !== typeof h && 'texture' === h.type && void 0 !== b[h.stream] && ++e;
          1 < e && (a.G = !1);
          l = C(Object.keys(c));
          f = l.next();
        case 2:
          ...
          if ('detection_list' === r.type) {
            if (p) {
              ...
              for (var I = p.getLandmarksList(), D = p.getClassificationsList(), u = [], z = 0; z < A.size(); ++z) {
                ...
                S = {
                  T: { Y: W(S, 1), Z: W(S, 2), height: W(S, 3), width: W(S, 4), rotation: W(S, 5, 0), W: rb(S, 6) },
                  O: Zb(I.get(z)),
    ...
    return H(function (e) {
      return 'number' === typeof c || c instanceof Uint8Array || c instanceof a.h.Uint8BlobList
        ...
        : c instanceof a.h.Texture2dDataOut
          ? ((d = a.s[b]), d || ((d = new $b(a.h, a.D)), (a.s[b] = d)), e.return(ac(d, c, a.G)))
          : e.return(void 0);
    });
  }
  function mc(a, b) {
  ...
  function rc(a) {
    ...
    this.g = new ic({
      ...
      listeners: [
        {
          ...
          outs: {
            ...
            poseLandmarks: { type: 'proto', stream: 'pose_landmarks', transform: Zb },
      ...
      options: {
        ...
        selfieMode: {
          type: 0,
          graphOptionXref: { calculatorType: 'GlScalerCalculator', calculatorIndex: 1, fieldName: 'flip_horizontal' },
        },
        modelComplexity: {
          type: 1,
          graphOptionXref: {
